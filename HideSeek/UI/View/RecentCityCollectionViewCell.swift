//
//  RecentCityCollectionViewCell.swift
//  HideSeek
//
...
class RecentCityCollectionViewCell: UICollectionViewCell {
    var rect: CGRect!
    ...
    func setName(name: String) {
        ...
        self.nameBtn.addTarget(self, action: #selector(RecentCityCollectionViewCell.selectRegion), forControlEvents: UIControlEvents.TouchDown)
    }
