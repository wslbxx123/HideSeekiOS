...
class InAppPurchaseManager: PayManager, SKProductsRequestDelegate, SKPaymentTransactionObserver {
    ...
    func requestProductData(_ productId: String) {
    ...
    func verifyPurchase() {
        do {
            ...
            let dict: Any? = try JSONSerialization.jsonObject(with: result, options: JSONSerialization.ReadingOptions.allowFragments)
            if (dict != nil) {
