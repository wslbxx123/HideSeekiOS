...
class CustomRequestManager: AFHTTPRequestOperationManager {    
    func POST(URLString: String, paramDict: NSMutableDictionary, success: ((AFHTTPRequestOperation, AnyObject) -> Void)?, failure: ((AFHTTPRequestOperation?, NSError) -> Void)?) -> AFHTTPRequestOperation? {
